...
\newcommand{\thesissubtitle}{A framework for modeling phenomenas of financial accounting with resources, events and agents}
...
\setdate{03}{01}{2017} % Set date with 3 arguments: {day}{month}{year}.
