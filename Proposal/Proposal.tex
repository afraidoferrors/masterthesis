...
\newcommand{\thesistitle}{Financial accounting with REA} % The title of the thesis. The English version should be used, if it exists.
\newcommand{\thesissubtitle}{A framework for modeling phenomenas of financial accounting with Ressources, Events and Agents}
...
\setdate{22}{12}{2016} % Set date with 3 arguments: {day}{month}{year}.
